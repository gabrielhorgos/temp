...
import com.bmw.gcdm.api.login.v5.entity.Authentication;
import com.bmw.gcdm.api.login.v5.entity.Session;
import com.bmw.gcdm.bm.login.v5.boundary.AuthenticationBF;
...
public class AuthenticateApiResource {
    ...
    public Response authenticate(@Parameter(description = "Client's ID",
            required = true) @PathParam("clientId") @NotNull @Size(min = 1) final String clientId,
                                 @Parameter(description = "Client's variant ID",
